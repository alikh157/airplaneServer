...
airplaneSchema.post('save',(error,doc,next)=>{
    (error.code===11000)?next(new JoiError("UniqueAirplaneError","Your airplane number or airplane airline name is repetitive",40,400,{"pointer":"/airPlane/makeAirplane","parameter":"req.data"})):next()
})
